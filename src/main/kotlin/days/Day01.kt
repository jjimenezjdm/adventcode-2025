 ...
 * to prevent their usual Christmas emergency. For example, they now know that the North Pole decorations
 ...
 * 
 * The attached document (your puzzle input) contains a sequence of rotations, one per line, which tell you
 * how to open the safe. A rotation starts with an L or R which indicates whether the rotation should be to
 * the left (toward lower numbers) or to the right (toward higher numbers). Then, the rotation has a distance
 ...
 * - The dial is rotated R48 to point at 0.  ← First time at 0
 * - The dial is rotated L5 to point at 95.
 * - The dial is rotated R60 to point at 55.
 * - The dial is rotated L55 to point at 0.  ← Second time at 0
 * - The dial is rotated L1 to point at 99.
 * - The dial is rotated L99 to point at 0.  ← Third time at 0
...
object Day01 {
    ...
    private fun solvePart1(input: List<String>): Int {
        ...
        // The password is the number of times the dial is left pointing at 0 after any rotation
        // The dial starts at 50
        // Rotations: L (left/lower) or R (right/higher) followed by a distance
      ...
      for (rotation in input) {
        ...
        val movements = rotation.substring(1).toInt()

        when (direction) {
          'L' -> point = (point - movements + 100) % 100
          'R' -> point = (point + movements) % 100
        }
